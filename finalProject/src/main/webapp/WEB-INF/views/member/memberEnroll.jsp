...
<script>
	$(function(){
		...
		$(".enrollPartner").click(function(){
			$("#type-select-border").css("left","50%");
		...
		$(".enrollUser").click(function(){
			$("#type-select-border").css("left","0px");
	...
	<div id="logo" style="text-align:center;">
		...
		<label class="main-label-han">일반 및 제휴 회원가입</label><br/>
		<label class="main-label-eng">Member or Partner Join</label><br/>
			...
			<table style="width:100%;">
				<tr style="text-align:center; cursor:pointer;">
					<td class="enrollUser" style="width:47.5%;">
						<label>User / </label><label style="font-size:42px;">&nbsp;일반 회원</label>
					</td>
					<td style="width:5%;">
						<label>ㅣ</label>
					</td>
					<td class="enrollPartner" style="width:47.5%;">
						<label>Partner / </label><label style="font-size:42px;">&nbsp; 제휴 회원</label>
					</td>
				</tr>
			</table>
		</div>
		<div id="type-select-border"></div>
